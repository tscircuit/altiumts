...
test("renders schematic pin name and designator with their custom fonts", async () => {
  const source = [
    ...
    "|RECORD=31|FONTIDCOUNT=3|SIZE1=10|FONTNAME1=Times New Roman|SIZE2=4|FONTNAME2=Helvetica|BOLD2=T|SIZE3=6|FONTNAME3=Helvetica|ITALIC3=T|CUSTOMX=100|CUSTOMY=80",
  ...
  expect(svg).toContain(
    'font-family="Helvetica" font-size="6" font-style="italic" font-weight="normal" text-decoration="none" text-anchor="end" dominant-baseline="text-after-edge" transform="translate(41.5 43.5) rotate(0)">1</text>',
  )
  expect(svg).toContain(
